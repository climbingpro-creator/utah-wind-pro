...
const CHAIN_DEFS = {
  ...
  'deer-creek:canyon_thermal': {
    ...
    nodes: [
      ...
      { id: 'UTCHL',       lag: -20, dir: [170, 220], speed: 4 },
      { id: 'KUTMIDWA37',  lag: -10, dir: [160, 240], speed: 3, optional: true },
      { id: 'UTDCD',       lag: -5,  dir: [170, 230], speed: 4 },
      { id: 'TEMPEST_DC',  lag: 0,   dir: [170, 260], speed: 3 },
    ],

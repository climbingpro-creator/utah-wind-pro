...
const WATER_LOCATIONS = {
  ...
  'willard-bay':      { type: 'reservoir', name: 'Willard Bay', primarySpecies: 'Wiper', depths: { spring: '4-15 ft', summer: '6-20 ft', fall: '5-15 ft' }, regulations: 'Walleye: 6 fish, only 1 over 24". Wiper: 3. Crappie: 10. Yellow perch: 15. Gizzard shad: unlawful to possess except commercially preserved.', allowedMethods: ['fly', 'spin', 'bait'] },
  ...
  'fish-lake':        { type: 'natural_lake', name: 'Fish Lake', primarySpecies: 'Lake Trout / Kokanee', depths: { spring: '10-30 ft', summer: '30-80 ft', fall: '20-50 ft' }, regulations: 'Trout limit 4 (all species incl. Lake Trout & Kokanee). Only 1 over 24". Perch: no limit.', allowedMethods: ['fly', 'spin', 'bait'] },

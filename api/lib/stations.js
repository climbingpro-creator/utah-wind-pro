...
export const LAKE_STATIONS = {
  ...
  'east-canyon': {
    ...
    wuPws: ['KUTMORGA4', 'KUTHENEF1', 'KUTPARKCITY4'],
    primary: 'KSLC',
    hasAmbient: false,
  },
  'echo': {
  ...
  'willard-bay': {
    ...
    wuPws: ['KUTWILLA3', 'KUTBRIGHA6', 'KUTOGDEN32'],
    tempest: ['TEMPEST_148360', 'TEMPEST_93590'],
    primary: 'UR328',
    hasAmbient: false,
  },
  'pineview': {
    ...
    wuPws: ['KUTEDEN14', 'KUTOGDEN65', 'KUTOGDEN32'],
    tempest: ['TEMPEST_159080'],
    primary: 'UTPVD',
    hasAmbient: false,
  },
  'hyrum': {
  ...
  'bear-lake': {
    ...
    wuPws: ['KUTGARDE9', 'KUTLOGAN12'],
    tempest: ['TEMPEST_106250'],
    primary: 'UTGRC',
    hasAmbient: false,
  },
  // ── Strawberry variants ──
  'strawberry-ladders': {
    ...
    wuPws: ['KUTSTRAW1', 'KUTSTRAW2', 'KUTHEBER105'],
    primary: 'UTCOP',
    hasAmbient: false,
  },
  'strawberry-bay': {
  ...
  // ── Strawberry (parent key for fishing alerts) ──
  'strawberry': {
  ...
  'provo-lower': {
    ...
    synoptic: ['KPVU', 'KSLC', 'UTLPC', 'UTDCD'],
    wuPws: ['KUTPROVO83', 'KUTOREM47', 'KUTPLEAS11'],
    primary: 'KPVU',
    hasAmbient: false,
  },
  'provo-middle': {
    name: 'Middle Provo River',
    synoptic: ['KHCR', 'UTLPC', 'UTDCD', 'KSLC'],
    wuPws: ['KUTMIDWA37', 'KUTHEBER105', 'KUTHEBER26'],
    primary: 'KHCR',
    hasAmbient: false,
  },
  'provo-upper': {
    ...
    synoptic: ['KHCR', 'KSLC'],
    wuPws: ['KUTHEBER99', 'KUTHEBER105'],
    primary: 'KHCR',
    hasAmbient: false,
  },
  // ── Weber River Segments ──
  'weber-upper': {
    name: 'Upper Weber River',
    synoptic: ['KHCR', 'KSLC'],
    wuPws: ['KUTPARKCITY4', 'KUTKAMAS2', 'KUTCOALV2'],
    primary: 'KHCR',
    hasAmbient: false,
  },
  'weber-middle': {
    name: 'Middle Weber River',
    synoptic: ['KSLC', 'KHCR'],
    wuPws: ['KUTCOALV2', 'KUTPARKCITY4', 'KUTWANSH1'],
    primary: 'KSLC',
    hasAmbient: false,
  },
  'weber-lower': {
    name: 'Lower Weber River',
    synoptic: ['KSLC', 'KOGD'],
    wuPws: ['KUTMORGA4', 'KUTHENEF1', 'KUTCOALV2'],
    primary: 'KSLC',
    hasAmbient: false,
  },
  // ── Green River Segments ──
  'green-a': {
    name: 'Green River — Section A',
    synoptic: ['KVEL'],
    wuPws: ['KUTVERNA22', 'KUTVERNA51', 'KUTVERNA15'],
    primary: 'KVEL',
    hasAmbient: false,
  },
  'green-b': {
    name: 'Green River — Section B',
    synoptic: ['KVEL'],
    wuPws: ['KUTVERNA22', 'KUTVERNA51'],
    primary: 'KVEL',
    hasAmbient: false,
  },
  'green-c': {
    name: 'Green River — Section C',
    synoptic: ['KVEL'],
    wuPws: ['KUTVERNA22'],
    primary: 'KVEL',
    hasAmbient: false,
  ...
  'potm-south': {
    ...
    tempest: ['TEMPEST_124015', 'TEMPEST_194125'],
    primary: 'FPS',
    hasAmbient: false,
  },
  'potm-north': {

...
const VENTURI_CORRIDORS = [
  ...
  {
    id: 'provo-canyon-upper',
    bounds: [
      [40.40, -111.55], [40.40, -111.47],
      [40.46, -111.46], [40.46, -111.54],
    ],
    axis: 210,
    maxBoost: 0.30,
    exponent: 3,
  ...
  {
    id: 'spanish-fork-canyon',
    bounds: [
      [40.05, -111.70], [40.05, -111.60],
      [40.15, -111.60], [40.15, -111.70],
    ],
    axis: 150,
    maxBoost: 0.20,
    exponent: 3,
  },
  {
    id: 'weber-canyon',
    bounds: [
      [41.15, -111.95], [41.15, -111.85],
      [41.25, -111.85], [41.25, -111.95],
    ],
    axis: 195,
    maxBoost: 0.15,
    exponent: 2,

...
const KNOWN_WATER_BODIES = [
  { id: 'strawberry',     name: 'Strawberry Reservoir', lat: 40.17, lng: -111.17, radiusMi: 7, type: 'reservoir', elevation: 7600, species: ['Cutthroat Trout', 'Kokanee Salmon', 'Rainbow Trout'], regulations: 'Cutthroat slot limit active (15-22" must be released)', targetDepth: '15-30 ft (thermocline zone)', forage: 'Utah Chub, Chironomids, Scuds' },
  { id: 'deer-creek',     name: 'Deer Creek Reservoir', lat: 40.41, lng: -111.51, radiusMi: 4, type: 'reservoir', elevation: 5400, species: ['Walleye', 'Brown Trout', 'Yellow Perch', 'Smallmouth Bass'], regulations: 'Walleye limit 10, only 1 over 24"', targetDepth: '18-30 ft (summer thermocline)', forage: 'Threadfin Shad, Crayfish, Perch' },

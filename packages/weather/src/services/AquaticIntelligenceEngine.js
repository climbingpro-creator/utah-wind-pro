...
const KNOWN_WATER_BODIES = [
  ...
  { id: 'willard-bay',    name: 'Willard Bay Reservoir',   lat: 41.38, lng: -112.08, radiusMi: 4, type: 'reservoir', elevation: 4200, species: ['Wiper', 'Walleye', 'Channel Catfish', 'Crappie'], regulations: 'Walleye 6 (only 1 over 24"), wiper 3, crappie 10, yellow perch 15. Gizzard shad unlawful to possess.', targetDepth: '8-20 ft (along dikes)', forage: 'Gizzard Shad, Crayfish' },

...
export const northernUtahConfigs = {
  ...
  'bear-lake': {
    ...
    stations: {
      ...
      ridge: [
        ...
        { id: 'BLPU1', name: 'Ben Lomond Peak', elevation: 7688, role: 'Wasatch ridge reference', priority: 2 },
      ],
      ...
      earlyIndicator: {
        ...
        elevation: 4457,
        role: 'Early Warning — W/NW flow in Cache Valley precedes Bear Lake by ~60 min',
        leadTimeMinutes: 60,
        trigger: {
          direction: { min: 250, max: 330, label: 'W/NW' },
      ...
      lakeshore: [
        ...
        { id: 'UTLTS', name: 'SR-30 Laketown Summit (UDOT)', elevation: 6500, role: 'East side pass reference', priority: 3 },
        { id: 'KLGU', name: 'Logan-Cache Airport', elevation: 4457, role: 'Regional ASOS (upstream)', priority: 4 },
      ],
      reference: [
        ...
        { id: 'KHIF', name: 'Hill Air Force Base', elevation: 4783 },
      ],
    },
    thermal: {
  ...
  'east-canyon': {
    ...
    coordinates: { lat: 40.8920, lng: -111.5940 },
    elevation: 5700,
    surfaceAcres: 680,
    maxDepth: 120,
    primaryWindType: 'Canyon Channeled SW',
    thermalDirection: 'SW to W (200-270°)',
    description: 'Mountain canyon reservoir — Weber/I-80 corridor funnels SW wind',
    stations: {
      pressure: {
        high: { id: 'KSLC', name: 'Salt Lake City Intl', elevation: 4226, role: 'Western pressure reference' },
        low: { id: 'KOGD', name: 'Ogden-Hinckley Airport', elevation: 4440, role: 'Northern valley pressure' },
        bustThreshold: 2.5,
      },
      ridge: [
        { id: 'OGP', name: 'Ogden Peak (Snowbasin)', elevation: 9570, role: 'Wasatch ridge — elevated flow indicator', priority: 1 },
        { id: 'BLPU1', name: 'Ben Lomond Peak', elevation: 7688, role: 'Northern ridge reference', priority: 2 },
      ],
      groundTruth: { id: 'KUTMORGA4', name: 'Morgan (WU)', role: 'Ground Truth — WU station in Morgan Valley' },
      earlyIndicator: {
        id: 'KSLC',
        name: 'Salt Lake City Intl',
        elevation: 4226,
        role: 'Early Warning — W/SW flow at SLC enters Parley\'s/I-80 canyon ~75 min before East Canyon',
        leadTimeMinutes: 75,
        trigger: {
      ...
      lakeshore: [
        { id: 'KUTMORGA4', name: 'Morgan (WU)', elevation: 5100, role: 'Primary — Morgan Valley near reservoir', priority: 1 },
        { id: 'KUTHENEF1', name: 'Henefer (WU)', elevation: 5300, role: 'Weber Canyon corridor east', priority: 2 },
        { id: 'KOGD', name: 'Ogden-Hinckley Airport', elevation: 4440, role: 'North valley reference', priority: 3 },
      ],
      reference: [
        { id: 'KSLC', name: 'Salt Lake City Intl', elevation: 4226 },
        { id: 'KUTPARKCITY4', name: 'Park City (WU)', elevation: 6900 },
        { id: 'KUTCOALV2', name: 'Coalville (WU)', elevation: 5600 },
        { id: 'KUTWANSH1', name: 'Wanship (WU)', elevation: 5800 },
        { id: 'UTALP', name: 'Point of the Mountain', elevation: 4796 },
        { id: 'KHIF', name: 'Hill Air Force Base', elevation: 4783 },
      ],
    },
    thermal: {
      optimalDirection: { min: 200, max: 270, ideal: 235 },

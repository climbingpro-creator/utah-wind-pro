...
export const STATION_REGISTRY = {
  ...
  SBDU1: {
    id: 'SBDU1',
    name: 'Strawberry Divide SNOTEL',
    shortName: 'Strawberry Div',
    lat: 40.1700,
    lng: -111.2000,
    elevation: 8100,
    type: 'snotel',
    network: 'NRCS',
    roles: ['strawberry-ridge'],
  },
  DANU1: {
    id: 'DANU1',
    name: 'Daniels Summit',
  ...
  CRU1: {
    id: 'CRU1',
    name: 'Currant Creek',
    shortName: 'Currant Creek',
    lat: 40.2300,
    lng: -111.0900,
    elevation: 7900,
    type: 'mesonet',
    network: 'MesoWest',
    roles: ['strawberry-east'],
  },
  ...
  UFCU1: {
    ...
    shortName: 'Fairview Cyn',
    lat: 39.6200,
    lng: -111.3000,
    elevation: 9200,
    type: 'rwis',
    network: 'UDOT',
    roles: ['skyline-primary'],
  },
  EPHU1: {
    id: 'EPHU1',
    name: 'Ephraim',

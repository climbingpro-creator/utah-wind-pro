...
import { Wind, Mail, Lock, ArrowLeft, Zap, CheckCircle, AlertCircle, Eye, EyeOff } from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full rounded-lg bg-white/[0.04] border border-white/[0.08] pl-10 pr-10 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-sky-500/50 focus:ring-1 focus:ring-sky-500/30"
                />
                <button
                  type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength={6}
                    className={`w-full rounded-lg bg-white/[0.04] border pl-10 pr-10 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-sky-500/50 focus:ring-1 focus:ring-sky-500/30 ${
